...
<section class="banner">
  <div id="bannerSlider" class="carousel carousel-fade slide" data-ride="carousel">
    <div class="carousel-inner">
      <div class="item active" style="background-image:url(images/stockholm-bg.jpg);">
...
<section class="feature-styles" id="features">
  <div class="container feature-container">
    ...
    <div class="col-lg-pull-6 col-md-6 col-sm-12 col-xs-12">
      <h1>Hur fungerar Lägenhetsbevakning.se?</h1>
      <div class="txt">Lägenhetsbevakning.se söker automatiskt efter hyreslägenheter, med förstahandskontrakt i Stockholmsområdet. När vi hittar en hyreslägenhet som passar era preferenser kontaktar vi er direkt via SMS/mail. Skulle ni inte stå i någon bostadskö kan ni stänga av aviseringar för lägenheter som kräver att ni står i den specefika bostadskö. </div>
    </div>
  </div>
