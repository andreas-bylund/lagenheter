    ...
    <div class="card-box">
      ...
      <form class="" action="index.html" method="post">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group m-l-10">
              <select class="form-control" id="hyra_min">
          ...
          <div class="col-md-4">
            <div class="form-group m-l-10">
              <select class="form-control" id="hyra_max">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group m-l-10">
              <select class="form-control" id="rum_min">
          ...
          <div class="col-md-4">
            <div class="form-group m-l-10">
              <select class="form-control" id="rum_max">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group m-l-10">
              <select class="form-control" id="kvm_min">
          ...
          <div class="col-md-4">
            <div class="form-group m-l-10">
              <select class="form-control" id="kvm_max">
